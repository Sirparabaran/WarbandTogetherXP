...
####################################################################################################################
    ...
    ] + [ ["player_%04d"%(player_index),"Player","Player",tf_hero|tf_unmoveable_in_party_window,no_scene,reserved,fac_player_faction,
   [],
   str_4|agi_4|int_4|cha_4,wp(15),0,0x000000018000000136db6db6db6db6db00000000001db6db0000000000000000] for player_index in range(0, players_number) ] + [
...
#   def_attrib_multiplayer|level(20),wp_melee(100)|wp_crossbow(120),knows_common_multiplayer|knows_riding_4|knows_shield_3|knows_ironflesh_3|knows_horse_archery_2|knows_power_strike_3|knows_athletics_2|knows_shield_2,swadian_face_young_1, swadian_face_old_2],
  ...
  ["items_array","Items Array","Items Array",tf_hero,no_scene,reserved,fac_commoners,[],def_attrib,0,knows_common,0],
  ["broken_items","Broken Items","Broken Items",tf_hero,no_scene,reserved,fac_commoners,[],def_attrib,0,knows_common,0],
  ["oil_array","Oil Array","Oil Array",tf_hero,no_scene,reserved,fac_commoners,[],def_attrib,0,knows_common,0],
