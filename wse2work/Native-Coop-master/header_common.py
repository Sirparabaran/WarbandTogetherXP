...
# Coop battle server event channels (server-side and client-side communication)
multiplayer_event_coop_send_to_server                         = 126
multiplayer_event_coop_send_to_player                         = 127
multiplayer_event_coop_send_to_player_string                  = 128
...
multiplayer_event_multiplayer_campaign_server_event_camera_follow_party       = 4
...
multiplayer_event_multiplayer_campaign_server_event_encounter_resolved       = 9
multiplayer_event_multiplayer_campaign_server_event_battle_available         = 10
...
multiplayer_event_multiplayer_campaign_server_event_center_encounter   = 27
multiplayer_event_multiplayer_campaign_server_event_center_locked      = 28
multiplayer_event_multiplayer_campaign_server_event_center_trade_price = 29
multiplayer_event_multiplayer_campaign_server_event_trade_merchant_slot = 30
multiplayer_event_multiplayer_campaign_server_event_trade_sync_done    = 31
multiplayer_event_multiplayer_campaign_server_event_trade_gold_sync    = 32
...
multiplayer_event_multiplayer_campaign_server_event_hero_sync_xp       = 43
# Battle request outcome: param 0 = rejected (no free battle server slot),
# param 1 = aborted (battle server lost mid-battle) (44)
multiplayer_event_multiplayer_campaign_server_event_battle_rejected    = 44
# Battle slot freed (result applied or aborted) -- clears the client's
# battle-chooser entry for that slot so a finished battle stops being listed (45)
multiplayer_event_multiplayer_campaign_server_event_battle_slot_closed  = 45

#multiplayer campaign client events
multiplayer_event_multiplayer_campaign_leave_encounter = 0
multiplayer_event_multiplayer_campaign_start_battle = 1
multiplayer_event_multiplayer_campaign_char_creation_bg   = 2
multiplayer_event_multiplayer_campaign_char_creation_life = 3
multiplayer_event_multiplayer_campaign_raise_attribute   = 4
...
# 8-9 were party_sync_begin/stack; 8 reclaimed for identify (client
# self-reports its Steam account id as lo16/hi16, 0/0 = no Steam),
# 9 for the upgradeable-counts pull: the hydrate-time ev-22 push races
# native roster replication on a joining client, so the client requests
# a re-push once its replicated party is visible.
multiplayer_event_multiplayer_campaign_request_party_upgradeable = 9
...
multiplayer_event_multiplayer_campaign_enter_center         = 18
multiplayer_event_multiplayer_campaign_leave_center         = 19
multiplayer_event_multiplayer_campaign_request_trade        = 20
multiplayer_event_multiplayer_campaign_trade_change         = 21
multiplayer_event_multiplayer_campaign_trade_done           = 22
multiplayer_event_multiplayer_campaign_request_recruit      = 23
# Local SP encounter client events (16-17 free, 24-25 new)
multiplayer_event_multiplayer_campaign_start_local_fight    = 16
multiplayer_event_multiplayer_campaign_local_fight_result   = 17
multiplayer_event_multiplayer_campaign_start_local_visit    = 24
multiplayer_event_multiplayer_campaign_local_visit_done     = 25
# Coop siege request: player assaults a hostile center on the battle server (26)
multiplayer_event_multiplayer_campaign_request_siege        = 26
